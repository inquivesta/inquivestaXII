                ...
                <div className="space-y-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-[#1A1A1A]/50 p-6 rounded-lg border border-[#D2B997]/30 hover:border-[#D2B997]/60 transition-colors">
                      ...
                      <p className="text-[#F4D03F] font-futura text-3xl mb-3">₹1,000 <span className="text-lg text-[#D2B997]">/day</span></p>
                    ...
                    <div className="bg-[#1A1A1A]/50 p-6 rounded-lg border border-[#D2B997]/30 hover:border-[#D2B997]/60 transition-colors">
                      ...
                      <p className="text-[#F4D03F] font-futura text-3xl mb-3">₹1,500 <span className="text-lg text-[#D2B997]">/day</span></p>
                      <p className="text-[#D2B997]/80 font-depixel-small text-sm">
                  ...
                  <div className="bg-gradient-to-r from-[#F4D03F]/10 to-[#D2B997]/10 p-6 rounded-lg border-2 border-[#F4D03F]/50">
                    ...
                    <p className="text-[#F4D03F] font-futura text-3xl">₹2,900 <span className="text-lg text-[#D2B997]">for 2 days</span></p>
                    <p className="text-[#D2B997]/80 font-depixel-small text-sm mt-3">
                      Save ₹100! Perfect if you want maximum exposure for 2 days.
                    </p>
                  </div>
