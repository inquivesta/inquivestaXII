...
const events: Event[] = [
  ...
  },
  {
    ...
    detailedDescription: "Inquizzitive is a quiz event where participants compete in various rounds of questions covering a wide range of topics including science, history, current affairs, and more. Teams will face off in elimination rounds to test their knowledge and speed.\n\nEVENT FORMAT:\n• Preliminary rounds with multiple-choice and short answer questions\n• Buzzer rounds for rapid-fire questions\n• Final round for top teams\n\nPRIZES:\n• Winner: ₹X,XXX\n• Runner-up: ₹X,XXX\n• Participation certificates for all",
    image: "/placeholder-logo.png",
    category: "Competition",
    venue: "Room G06",
    prizes: "Prize Pool: ₹30,000",
