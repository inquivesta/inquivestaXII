...
import { ArrowLeft, CheckCircle, Gamepad2, Trophy, Glasses } from "lucide-react"
...
const EVENT_CONFIG = {
  id: "headshot-vr",
  name: "Headshot - VR",
  subtitle: "Virtual Reality Gaming Tournament",
  fee: 100,
  prizePool: 5000,
}

export default function HeadshotVRRegistrationPage() {
        ...
        <main className="container mx-auto px-4 py-20">
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center">
              <div className="mb-8">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-r from-[#FF6B6B] to-[#4ECDC4] rounded-full flex items-center justify-center">
                  <CheckCircle className="w-12 h-12 text-[#1A1A1A]" />
                </div>
                <HyperText
                  className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-[#FF6B6B] to-[#4ECDC4] bg-clip-text text-transparent font-futura tracking-wide"
                  text="REGISTERED!"
                />
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3 text-left">
                    ...
                    <div className="flex justify-between py-2 border-b border-[#D2B997]/20">
                      ...
                      <span className="text-[#4ECDC4] font-futura tracking-wide text-xl">₹{EVENT_CONFIG.fee}</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#1A1A1A]/50 p-4 rounded-lg text-sm text-[#D2B997]/80 font-depixel-small space-y-2">
                    ...
                    <p>🎮 Get ready for an immersive VR experience!</p>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full">
                <Link href="/events" className="w-full sm:w-auto">
                  <Button className="w-full sm:w-auto bg-gradient-to-r from-[#FF6B6B] to-[#4ECDC4] hover:from-[#E65C5C] hover:to-[#3DBDB5] text-[#1A1A1A] font-depixel-body px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base">
                    Explore More Events
                  </Button>
                </Link>
        ...
        <main className="container mx-auto px-4 py-20">
          <FadeIn>
            <div className="text-center mb-12">
              <HyperText
                className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#FF6B6B] to-[#4ECDC4] bg-clip-text text-transparent font-futura tracking-wide"
                text="HEADSHOT - VR"
              />
              ...
              <div className="mt-4 flex flex-wrap justify-center gap-4">
                <div className="inline-flex items-center gap-2 bg-[#FF6B6B]/10 border border-[#FF6B6B]/30 px-4 py-2 rounded-full">
                  <Glasses className="w-4 h-4 text-[#FF6B6B]" />
                  <span className="text-[#FF6B6B] font-depixel-small">VR Experience</span>
                </div>
                <div className="inline-flex items-center gap-2 bg-[#4ECDC4]/10 border border-[#4ECDC4]/30 px-4 py-2 rounded-full">
                  <span className="text-[#4ECDC4] font-depixel-small">₹{EVENT_CONFIG.fee} Entry</span>
                </div>
          ...
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
              ...
              <Card className="bg-[#2A2A2A]/50 border-[#D2B997]/30">
                <CardHeader>
                  <CardTitle className="text-2xl text-[#D2B997] font-futura tracking-wide flex items-center gap-2">
                    <Glasses className="w-6 h-6 text-[#FF6B6B]" />
                    Participant Details
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                ...
                <CardContent>
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="bg-gradient-to-r from-[#FF6B6B]/10 to-[#4ECDC4]/10 rounded-lg border border-[#D2B997]/20 p-4">
                        <div className="flex justify-between items-center">
                          <span className="text-white font-depixel-body">Registration Fee:</span>
                          <span className="text-[#4ECDC4] font-futura tracking-wide text-3xl">₹{EVENT_CONFIG.fee}</span>
                        </div>
            ...
            {/* Submit Button */}
            <FadeIn delay={0.4}>
              <div className="bg-[#4ECDC4]/10 border border-[#4ECDC4]/30 p-4 rounded-lg mb-6">
                <p className="text-[#4ECDC4] font-depixel-small text-sm">
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-[#FF6B6B] to-[#4ECDC4] hover:from-[#E65C5C] hover:to-[#3DBDB5] text-[#1A1A1A] font-depixel-body py-6 text-base disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
