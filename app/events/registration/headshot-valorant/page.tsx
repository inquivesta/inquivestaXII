...
import { ArrowLeft, Users, CheckCircle, Crosshair } from "lucide-react"
...
export default function HeadshotValorantRegistrationPage() {
  ...
  const [players, setPlayers] = useState<Player[]>([
    { name: "", phone: "", email: "", game_id: "" }, // Player 1 (IGL)
        ...
        <main className="container mx-auto px-4 py-20">
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center">
              <div className="mb-8">
                <div className="w-24 h-24 mx-auto mb-6 bg-gradient-to-r from-[#FF4655] to-[#BD3944] rounded-full flex items-center justify-center">
                  <CheckCircle className="w-12 h-12 text-white" />
                </div>
                <HyperText
                  className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-[#FF4655] to-[#BD3944] bg-clip-text text-transparent font-futura tracking-wide"
                  text="REGISTERED!"
                />
                <p className="text-[#D2B997] text-lg font-depixel-body mb-8">
                  Your team is locked in for {EVENT_CONFIG.name}
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center w-full">
                <Link href="/events" className="w-full sm:w-auto">
                  <Button className="w-full sm:w-auto bg-gradient-to-r from-[#FF4655] to-[#BD3944] hover:from-[#E63E4C] hover:to-[#A8323A] text-white font-depixel-body px-6 sm:px-8 py-5 sm:py-6 text-sm sm:text-base">
                    Explore More Events
                  </Button>
                </Link>
        ...
        <main className="container mx-auto px-4 py-20">
          <FadeIn>
            <div className="text-center mb-12">
              <HyperText
                className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-[#FF4655] to-[#BD3944] bg-clip-text text-transparent font-futura tracking-wide"
                text="HEADSHOT - VALORANT"
              />
              <p className="text-[#D2B997] text-lg font-depixel-body">
                Tactical Shooter Tournament
              </p>
          ...
          <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
                ...
                <Card className="bg-[#2A2A2A]/50 border-[#D2B997]/30">
                  <CardHeader>
                    <CardTitle className="text-xl text-[#D2B997] font-futura tracking-wide flex items-center gap-2">
                      ...
                      Player {index + 1} {index === 0 && <span className="text-[#FF4655] text-sm">(In-Game Leader)</span>}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <Label className="text-[#D2B997] font-depixel-small text-xs">Riot Game ID *</Label>
                        <Input
                          required
                          value={player.game_id}
                          onChange={(e) => updatePlayer(index, "game_id", e.target.value)}
                          className="bg-[#1A1A1A] border-[#D2B997]/30 text-white font-depixel-small"
                ...
                <CardContent>
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 space-y-4">
                      <div className="bg-gradient-to-r from-[#FF4655]/10 to-[#BD3944]/10 rounded-lg border border-[#D2B997]/20 p-4">
            ...
            <FadeIn delay={0.55}>
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-[#FF4655] to-[#BD3944] hover:from-[#E63E4C] hover:to-[#A8323A] text-white font-depixel-body py-6 text-base disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
                  ...
                  <>
                    ...
                    Register Team - ₹{EVENT_CONFIG.fee}
                  </>
                )}
              </Button>
            </FadeIn>
