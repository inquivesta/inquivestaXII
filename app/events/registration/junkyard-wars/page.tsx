...
export default function JunkyardWarsRegistrationPage() {
  ...
  // Start with 1 additional member (min team size is 2, so 1 leader + 1 member)
  ...
  const removeTeamMember = (index: number) => {
    // Keep at least 1 member (minTeamSize - 1 for leader)
          ...
          <FadeIn>
            <div className="text-center mb-12">
              ...
              <p className="text-[#D2B997] text-lg font-depixel-body">
                Build something amazing from scrap!
              </p>
            ...
            <FadeIn delay={0.2}>
              <Card className="bg-[#2A2A2A]/50 border-[#D2B997]/30">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div>
                    <Label htmlFor="team_leader_college" className="text-[#D2B997] font-depixel-small">College Name *</Label>
                    <Input
